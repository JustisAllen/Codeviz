...
public class Codeviz {
    public static void main(String[] args) throws Exception {
        ...
        Optional<MethodDeclaration> mainMethod = getMethod(methodToParse, cu);
    ...
    /**
     * @return The {@link MethodDeclaration} (wrapped in an {@link Optional}) in {@code cu}
     *		corresponding to the method with the specified {@code methodName}
     *		--{@link Optional#empty()} if the method does not exist.
     */
    public static Optional<MethodDeclaration> getMethod(String methodName, CompilationUnit cu) {
     ...
     * 		representing {@code comment} if {@code comment} can be parsed
     *		to one; {@link Optional#empty()} otherwise.
     */
